...
class Doppler:
    ...
    def __init__(self, toe,t_data,mu0, delta_n, e, omega0, Cws, Cwc, a, Crc, Crs, Cic, Cis, omega_ascension0, omega_dot_ascension, i0, i_dot):
...
if __name__ == "__main__":
    ...
    velocity = Doppler(208784,208789,0.128612756881*10,0.489020369661*10**-8,0.260362529662*10**-2,0.7931942133,0.622682273388*10**-5,0.1460313797*10**-5,0.515365547943*10**4,0.25971875*10**3,0.2853125*10**2,-0.204890966415*10**-7,0.577419996262*10**-7,0.108886242411*10,-0.815426822943*10**-8,0.963852456438,0.431089385175*10**-9)
